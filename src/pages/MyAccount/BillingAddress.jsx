...
const BillingAddress = ({setShowBilling}) => {
    ...
    const address = useSelector((state) => state.user.data?.addresses?.billing);
...
const navigate = useNavigate()
    ...
    const saveBillingAddress = async (formData, address, token) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const data = await saveBillingAddress(formData, address, token);

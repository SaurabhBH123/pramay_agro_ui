                ...
                <div className="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
                    <svg className="h-6 mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g>
                            ...
                            <path d="M53.527,192.864c-2.187,3.518-1.109,8.142,2.409,10.329l183.478,114.081c1.232,0.767,2.601,1.132,3.953,1.132 c2.506,0,4.956-1.256,6.376-3.541c2.187-3.518,1.109-8.142-2.409-10.329L63.855,190.454C60.337,188.268,55.712,189.347,53.527,192.864z"> </path>
                        </g>
                    </svg>
                    Latest Updates
                </div>
                <a href="#"
                    className="pb-2 text-grey-dark border-b-2 border-transparent uppercase hover:text-black hover:border-black transition duration-300 ease-in-out">
                    View All
                </a>
            </div> */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <a href="#" className="card">
                    <div className="card__image overflow-hidden rounded-lg mb-5">
                        <img className="object-cover" src="https://images.pexels.com/photos/61180/pexels-photo-61180.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="Gaming" />
                    </div>
                    <div className="card__body">
                        <div className="card__title text-lg mb-2 font-bold font-heading">
                            Microsoft acquires Bethesda for 7.5 Billion
                        </div>
                        <div className="card__description text-sm text-grey-dark">
                            Microsoft has announced its acquisition of Bethesda in a $7.5 billion deal, expanding its gaming portfolio.
                        </div>
                    </div>
                </a>
                {/* Card 2 */}
                <a href="#" className="card">
                    <div className="card__image overflow-hidden rounded-lg mb-5">
                        <img className="object-cover" src="https://images.pexels.com/photos/1600727/pexels-photo-1600727.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="Technology" />
                    </div>
                    <div className="card__body">
                        <div className="card__title text-lg mb-2 font-bold font-heading">
                            Apple's New M1 Chip Revolutionizes Computing
                        </div>
                        <div className="card__description text-sm text-grey-dark">
                            Apple has introduced the M1 chip, offering unprecedented performance and battery life for its new line of computers.
                        </div>
                    </div>
                </a>
                {/* Card 3 */}
                <a href="#" className="card">
                    <div className="card__image overflow-hidden rounded-lg mb-5">
                        <img className="object-cover" src="https://images.pexels.com/photos/6086/food-salad-healthy-vegetables.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="Nature" />
                    </div>
                    <div className="card__body">
                        <div className="card__title text-lg mb-2 font-bold font-heading">
                            Nature's Beauty: Exploring the Great Outdoors
                        </div>
                        <div className="card__description text-sm text-grey-dark">
                            Discover the most breathtaking nature spots around the world and plan your next adventure.
                        </div>
                    </div>
                </a>
            </div>
